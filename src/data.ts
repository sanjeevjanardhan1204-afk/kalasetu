...
export const TRANSLATIONS: Record<Language, Translation> = {
  en: {
    weaverView: 'Weaver Mode (Seller)',
    buyerView: 'Buyer Mode (Customer)',
    languageName: 'English',
    logoSub: 'Weaver-to-Buyer Direct Voice Market',
    ...
    myListedProducts: 'My Handloom Products',
    ...
    searchTitle: 'Conversational Weaver Search',
    weaverStory: "The Weaver's Story",
    hearWeaverStory: "▶ Hear the weaver's story",
    ...
    weaverEarnings: 'Weaver Direct Earnings (91%)',
    payWithUpi: 'Pay Instantly with UPI / QR',
    orderConfirmed: 'Order Confirmed!',
    trackStatus: 'Track Order Progress'
  },
  kn: {
    weaverView: 'ನೇಕಾರರ ವಿಭಾಗ (ಮಾರಾಟ)',
    buyerView: 'ಖರೀದಿದಾರರ ವಿಭಾಗ (ಗ್ರಾಹಕ)',
    languageName: 'ಕನ್ನಡ',
    logoSub: 'ನೇಕಾರರು ಮತ್ತು ಗ್ರಾಹಕರ ನೇರ ಧ್ವನಿ ಮಾರುಕಟ್ಟೆ',

    weaverDashboard: 'ನೇಕಾರರ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್',
    ...
    myListedProducts: 'ನನ್ನ ಕೈಮಗ್ಗ ಉತ್ಪನ್ನಗಳು',
    ...
    searchTitle: 'ನೇಕಾರರ ಹುಡುಕಾಟ ಸಂಭಾಷಣೆ',
    weaverStory: 'ನೇಕಾರರ ಕಥೆ',
    hearWeaverStory: '▶ ನೇಕಾರರ ಕಥೆಯನ್ನು ಆಲಿಸಿ',
  ...
  hi: {
    ...
    myListedProducts: 'मेरे हथकरघा उत्पाद',
    ...
    searchTitle: 'बुनकर खोज बातचीत',
    weaverStory: 'बुनकर की कहानी',
    hearWeaverStory: '▶ बुनकर की कहानी सुनें',
    ...
    weaverEarnings: 'बुनकर की सीधी कमाई (91%)',

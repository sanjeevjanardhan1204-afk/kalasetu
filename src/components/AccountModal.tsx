...
export const AccountModal: React.FC<AccountModalProps> = ({
  ...
  const translations = {
    en: {
      title: "My Taana Identity",
      subtitle: "Verified Handloom Ambassador Passport",
      weaverCardTitle: "Verified Master Weaver ID",
      ...
      trustShield: "Taana Certified Direct Link",
    ...
    kn: {
      ...
      subtitle: "ಧೃಡೀಕೃತ ನೇಕಾರರ ಗುರುತಿನ ಚೀಟಿ",
      weaverCardTitle: "ಧೃಡೀಕೃತ ನೇಕಾರರ ಪ್ರೊಫೈಲ್",
      ...
      directWeaverBenefit: "೧೦೦% ನೇಕಾರರಿಗೆ ನೇರ ಲಾಭ ವರ್ಗಾಯಿಸಲಾಗಿದೆ",
      ...
      weaverDirectEarn: "ನೇಕಾರರ ನೇರ ಆದಾಯ (೯೧%)",
      ...
      offlinePaymentQRTitle: "ಆಫ್‌ಲೈನ್ ನೇಕಾರರ ಪಾವತಿ ಕ್ಯೂಆರ್",
      offlinePaymentQRSubtitle: "ನೇರ ಯುಪಿಐ ಮತ್ತು ನಗದುರಹಿತ ವಹಿವಾಟು",
      scanToPay: "ಯಾವುದೇ ಯುಪಿಐ ಆ್ಯಪ್ ಮೂಲಕ ಸ್ಕ್ಯಾನ್ ಮಾಡಿ",
      weaverUPIHandle: "ನೇಕಾರರ ಯುಪಿಐ ಐಡಿ",
      collectionAmount: "ನೇಕಾರರಿಗೆ ಪಾವತಿಸಬೇಕಾದ ಮೊತ್ತ",
    ...
    hi: {
      ...
      subtitle: "सत्यापित हथकरघा डिजिटल पासपोर्ट",
      weaverCardTitle: "सत्यापित बुनकर पहचान पत्र",
      ...
      offlinePaymentQRTitle: "ऑफलाइन बुनकर भुगतान QR",
      offlinePaymentQRSubtitle: "सीधा UPI और कैशलेस भुगतान संग्रह",
      scanToPay: "किसी भी UPI ऐप से स्कैन करें",
      weaverUPIHandle: "सत्यापित बुनकर UPI आईडी",
      collectionAmount: "बुनकर को देय सीधी राशि",

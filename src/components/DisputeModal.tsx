      ...
      <div className="bg-white border border-cream-border rounded-3xl p-6 sm:p-8 text-left max-w-lg w-full shadow-2xl my-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Order #{order.id} &bull; Value: ₹{order.product.price}
              </p>
            </div>
          </div>
          <button
        ...
        {!dispute ? (
          <form onSubmit={handleRaiseDispute} className="space-y-5">
            <div className="bg-white border border-cream-border rounded-2xl shadow-xs p-5 space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-cream/40 border border-cream-border rounded-xl p-2.5 text-xs font-semibold text-charcoal focus:outline-none focus:border-terracotta"
                >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-cream/40 border border-cream-border rounded-xl p-2.5 text-xs text-charcoal focus:outline-none focus:border-terracotta"
                />
              </div>
            ...
            <div className="bg-mustard/10 p-4 rounded-2xl border border-mustard/30 text-[11px] text-amber-900 leading-snug">
              <span className="font-bold block mb-1">Important Protection Rule</span>
            ...
            <button
              ...
              className="w-full bg-rose-600 hover:bg-rose-600/90 text-white font-bold py-3.5 px-4 rounded-xl text-xs flex items-center justify-center gap-2 shadow-xs transition cursor-pointer"
            >
          ...
          <div className="space-y-5">
            ...
            {/* Nav Tabs */}
            <div className="flex flex-wrap gap-1.5 bg-cream/50 border border-cream-border rounded-full p-1.5">
              <button
                onClick={() => setActiveTab('details')}
                className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition ${
                  activeTab === 'details' ? 'bg-indigo-custom text-white' : 'text-gray-600 hover:bg-white'
                }`}
              >
                Dispute Overview
              </button>
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition flex items-center gap-1 ${
                  activeTab === 'artisan-respond' ? 'bg-terracotta text-white' : 'text-gray-600 hover:bg-white'
                }`}
              >
              ...
              >
                ...
                <span className="text-[9px] bg-white/20 px-1.5 py-0.2 rounded-full font-mono">4 Actions</span>
              </button>
            </div>
            ...
            {activeTab === 'details' && (
              <div className="bg-white border border-cream-border rounded-2xl shadow-xs p-5 space-y-4 text-xs">
                ...
                <div>
                  ...
                  <p className="font-bold text-rose-700 text-sm mt-1">{dispute.reason}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1.5 bg-cream/40 p-3 rounded-xl border border-cream-border font-serif italic">
                    "{dispute.description}"
                  </p>
                </div>
                ...
                {dispute.artisanResponse && (
                  <div>
                    ...
                    <p className="text-indigo-950 mt-1.5 bg-indigo-50/70 p-3 rounded-xl border border-indigo-100 font-serif italic">
            ...
            {activeTab === 'artisan-respond' && (
              <form onSubmit={handleArtisanRespond} className="bg-white border border-cream-border rounded-2xl shadow-xs p-5 space-y-4 text-xs">
                <div>
                  <h4 className="font-serif font-bold text-charcoal text-sm">Artisan Response Channel</h4>
                ...
                <button
                  ...
                  className="w-full bg-terracotta hover:bg-terracotta/90 text-white font-bold py-2.5 px-4 rounded-xl text-xs flex items-center justify-center gap-1.5 shadow-xs transition"
                >
            ...
            {activeTab === 'admin-resolve' && (
              <div className="bg-white border border-cream-border rounded-2xl shadow-xs p-5 space-y-4 text-xs">
                <div>
                  <h4 className="font-serif font-bold text-charcoal text-sm">Admin Resolution Workbench</h4>
                  <p className="text-[11px] text-gray-500 mt-1">
